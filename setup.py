...
METADATA = {
    ...
    'version':          '0.1.0',
    'license':          'GPL',
    'description':      'Unable to face life as an abomination, you turn on your alien creators',
    'author':           'Martin',
    #'author_email':     '',
...
PACKAGEDATA = {
    ...
    'package_dir': {'ShadowWorld': 'ShadowWorld',
                   },
    'packages': ['ShadowWorld',
                ],
    'scripts': ['scripts/ShadowWorld'],
}
...
_DATA_DIR = os.path.join('ShadowWorld', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'ShadowWorld': data_dirs}
...
src = []
add_files(src,os.walk('ShadowWorld'))
